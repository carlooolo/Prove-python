...
photo2= PhotoImage(file='download.png') #cambiare in base al tuo nome
...
def tab1():
    def tab2():
        ...
        button_esci.destroy()
        button_start= Button(f, text='START', background='#b0bbc1', activebackground='#78d6ff', command=set_text_by_button)
        button_start.pack(side=LEFT, padx=175)
        button_start['font']= myfont3
        button_stop= Button(f, text='STOP', background='#b0bbc1', activebackground='#78d6ff', command=set_text_by_button1)
